...
preencheHTML(tagPalavra,escondePalavra[1].join("  "));
exibeMsg("Você descobriu uma letra!");
...
contErros++;
preencheHTML(tagTotErros,contErros);
exibeMsg("Você errou que pena!");
    
if(contErros == 4)
finalizaJogo(false);
else
exibeMsg("Digite uma letra ");
...
if(acao)
verificaPalavraEnviada(prompt("Digite a Palavra","Digite a palavra aqui"));    
else
exibeMsg("Digite a letra desejada");
